        ...
        <div className="overflow-x-auto">
          ...
          <div className="">
            {teamMembers.map((member) => (
              <div key={member.id}>
                {/* Main Clickable Row */}
                <div className="px-3 py-3 w-[98%] flex justify-start items-center gap-6 hover:bg-gray-50 transition-all duration-200 cursor-pointer border border-gray-200 mx-4 my-3 rounded-2xl">
                  {/* Avatar + Name */}

                  {/* Campaign */}
                  <div
                    onClick={() => toggleRow(member.id)}
                    className="w-[15%] text-start text-sm font-bold text-gray-900"
                  >
                    {member.role}
                  </div>
                  ...
                  <div
                    onClick={() => toggleRow(member.id)}
                    className="flex w-[15%] items-center gap-4 flex-shrink-0 w-64"
                  >
                    <div className="relative">
                      <Image
                        ...
                        width={40}
                        height={40}
                        className={`w-10 h-10 rounded-full bg-gradient-to-br object-cover`}
                      />
                    </div>
                    <div>
                  ...
                  <div
                    onClick={() => toggleRow(member.id)}
                    className="w-[20%] text-start text-sm text-gray-600"
                  >
                    {member.email}
                  </div>
                  ...
                  <div
                    onClick={() => toggleRow(member.id)}
                    className=" w-[20%] flex flex-start items-center  text-center"
                  >
                  ...
                  <div
                    onClick={() => toggleRow(member.id)}
                    className="w-[20%] text-start text-sm font-bold text-gray-900"
                  >
                    {member.supervisor}
                  </div>
                  ...
                  <Link
                    ...
                    className="w-[10%] text-right cursor-pointer"
                  >
                    <button className="flex items-center gap-1 text-gray-500 cursor-pointer  text-sm transition-colors ml-auto">
                      View Details
