...
const trafficSources = [
  { name: "Direct", value: 400, color: DASHBOARD_CONSTANTS.COLORS.PRIMARY },
  { name: "Organic Search", value: 300, color: DASHBOARD_CONSTANTS.COLORS.SUCCESS },
  { name: "Social Media", value: 200, color: DASHBOARD_CONSTANTS.COLORS.WARNING },
  { name: "Email", value: 100, color: DASHBOARD_CONSTANTS.COLORS.DANGER },
  { name: "Referral", value: 150, color: DASHBOARD_CONSTANTS.COLORS.INFO }
];
    ...
    <Card className={className}>
      <CardHeader className="flex flex-row items-center justify-between">
        ...
        <Button variant="outline" size="sm">
          {DASHBOARD_CONSTANTS.BUTTONS.VIEW_ALL}
        </Button>
      </CardHeader>
      <CardContent>
        {children}
...
export function InteractiveCharts({ isLoading = false }: InteractiveChartsProps) {
  ...
  return (
    <div className="space-y-6">
      {/* Revenue Trend Chart */}
      <ChartCard
        title={DASHBOARD_CONSTANTS.CHARTS.REVENUE_TREND}
          ...
          <AreaChart data={revenueData}>
            <defs>
              <linearGradient id="colorRevenue" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor={DASHBOARD_CONSTANTS.COLORS.PRIMARY} stopOpacity={0.8}/>
                <stop offset="95%" stopColor={DASHBOARD_CONSTANTS.COLORS.PRIMARY} stopOpacity={0.1}/>
              </linearGradient>
            </defs>
            ...
            <Area 
              type="monotone" 
              dataKey="revenue" 
              stroke={DASHBOARD_CONSTANTS.COLORS.PRIMARY}
              fillOpacity={1}
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <ChartCard
          title={DASHBOARD_CONSTANTS.CHARTS.SALES_COMPARISON}
        ...
        >
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={salesData}>
              ...
              <Bar 
                dataKey="profit" 
                fill={DASHBOARD_CONSTANTS.COLORS.SUCCESS} 
                name="Profit"
                radius={[4, 4, 0, 0]}
              />
            </BarChart>
        ...
        <ChartCard
          title={DASHBOARD_CONSTANTS.CHARTS.TRAFFIC_SOURCES}
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {/* User Activity Chart */}
        <ChartCard
          title={DASHBOARD_CONSTANTS.CHARTS.USER_ACTIVITY}
          ...
          <ResponsiveContainer width="100%" height={250}>
            <LineChart data={userActivityData}>
              ...
              <Line 
                type="monotone" 
                dataKey="active" 
                stroke={DASHBOARD_CONSTANTS.COLORS.SUCCESS}
                strokeWidth={3}
                dot={{ fill: DASHBOARD_CONSTANTS.COLORS.SUCCESS, strokeWidth: 2, r: 4 }}
                activeDot={{ r: 6 }}
              />
            </LineChart>
          </ResponsiveContainer>
        ...
        {/* Performance Metrics */}
        <ChartCard
          title={DASHBOARD_CONSTANTS.CHARTS.PERFORMANCE_METRICS}
        ...
        >
          <ResponsiveContainer width="100%" height={250}>
            <BarChart data={revenueData.slice(-4)}>
              ...
              <Bar 
                dataKey="orders" 
                fill={DASHBOARD_CONSTANTS.COLORS.INFO}
                name="Orders"
                radius={[4, 4, 0, 0]}
              />
            </BarChart>
