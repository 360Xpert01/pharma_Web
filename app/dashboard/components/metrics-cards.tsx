...
export function MetricsCards({ data, isLoading = false }: MetricsCardsProps) {
  ...
  const metrics = [
    {
      title: DASHBOARD_CONSTANTS.METRICS.TOTAL_USERS,
    ...
    {
      title: DASHBOARD_CONSTANTS.METRICS.ACTIVE_SESSIONS,
    ...
    {
      title: DASHBOARD_CONSTANTS.METRICS.REVENUE,
    ...
    {
      title: DASHBOARD_CONSTANTS.METRICS.CONVERSION_RATE,
    ...
    {
      title: DASHBOARD_CONSTANTS.METRICS.ORDERS,
    ...
    {
      title: DASHBOARD_CONSTANTS.METRICS.GROWTH,
    ...
    {
      title: DASHBOARD_CONSTANTS.METRICS.BOUNCE_RATE,
    ...
    {
      title: DASHBOARD_CONSTANTS.METRICS.PAGE_VIEWS,
