...
export function RealTimeProvider({ children }: RealTimeProviderProps) {
  ...
  useEffect(() => {
    ...
    newSocket.on("connect", () => {
      ...
      setIsConnected(true);
      setConnectionStatus(DASHBOARD_CONSTANTS.MESSAGES.REAL_TIME_CONNECTED);
      setSocket(newSocket);
    });
    ...
    newSocket.on("disconnect", () => {
      ...
      setConnectionStatus(DASHBOARD_CONSTANTS.MESSAGES.REAL_TIME_DISCONNECTED);
    });
...
export function RecentActivities() {
  ...
  return (
    <div className="space-y-4">
      <h3 className="text-lg font-semibold">{DASHBOARD_CONSTANTS.SECTIONS.RECENT_ACTIVITY}</h3>
