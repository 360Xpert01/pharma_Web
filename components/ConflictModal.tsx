  ...
  const [products, setProducts] = useState<ConflictProduct[]>([
    {
      ...
      reps: [
        { id: "r1", name: "Rep 1", avatar: "/capMan.svg", share: 33 },
        { id: "r2", name: "Rep 2", avatar: "/capMan.svg", share: 33 },
        { id: "r3", name: "Rep 3", avatar: "/capMan.svg", share: 34 },
      ],
      isExpanded: true,
    },
    {
      ...
      productName: "Capsule 500Mg",
      reps: [
        { id: "r4", name: "Rep 4", avatar: "/capMan.svg", share: 50 },
        { id: "r5", name: "Rep 5", avatar: "/capMan.svg", share: 50 },
      ],
      isExpanded: true,
    },
    {
      ...
      reps: [
        { id: "r6", name: "Rep 6", avatar: "/capMan.svg", share: 33 },
        { id: "r7", name: "Rep 7", avatar: "/capMan.svg", share: 33 },
        { id: "r8", name: "Rep 8", avatar: "/capMan.svg", share: 34 },
      ],
      isExpanded: false,
    },
    {
      ...
      reps: [
        { id: "r9", name: "Rep 9", avatar: "/capMan.svg", share: 20 },
        { id: "r10", name: "Rep 10", avatar: "/capMan.svg", share: 20 },
        { id: "r11", name: "Rep 11", avatar: "/capMan.svg", share: 20 },
        { id: "r12", name: "Rep 12", avatar: "/capMan.svg", share: 20 },
        { id: "r13", name: "Rep 13", avatar: "/capMan.svg", share: 20 },
      ],
      isExpanded: false,
    },
    {
      ...
      reps: [
        { id: "r14", name: "Rep 14", avatar: "/capMan.svg", share: 50 },
        { id: "r15", name: "Rep 15", avatar: "/capMan.svg", share: 50 },
      ],
      isExpanded: false,
    },
  ]);
