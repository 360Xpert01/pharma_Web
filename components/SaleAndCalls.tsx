  ...
  return (
    <div className="w-full  ">
      <div className="flex justify-between mt-3 mb-2  my-auto  items-center">
        ...
        <div className="flex items-center   gap-1 text-xs text-(--primary) bg-(--background) px-3 py-1 rounded-md">
          ...
          <div className="flex items-end gap-4 justify-center">
            {salesProgress.map(({ time, value }) => (
              <div key={time} className="flex flex-col mb-3 items-center">
                ...
                {/* Progress Bar */}
                <div className="w-6 h-2 bg-(--gray-2) rounded-full overflow-hidden relative">
                  <div
