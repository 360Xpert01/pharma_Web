        ...
        <div className="flex items-center">
          {hasChildren ? (
            <button
              ...
              className="w-6 h-6 flex items-center justify-center hover:bg-gray-200 rounded transition-colors z-10 mr-2 cursor-pointer"
    ...
    return (
      <div className="w-full bg-(--background) rounded-lg border border-gray-200 shadow-soft">
        <div className="px-6 py-16 flex flex-col items-center justify-center">
          ...
          <p className="text-red-500 font-medium mb-2">Failed to load hierarchy</p>
    ...
    return (
      <div className="w-full bg-(--background) rounded-lg border border-gray-200 shadow-soft">
        <div className="px-6 py-16 flex flex-col items-center justify-center">
          ...
          <p className="text-gray-500 font-medium mb-2">No regions found</p>
