      ...
      <Tooltip>
        <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DropdownMenuTrigger asChild>
              <Button
                ...
                className={cn(
                  ...
                  currentLocale.dir === "rtl" && "font-arabic"
                )}
                aria-label={`${t("currentLanguage")}: ${currentLocale.name}. ${t("clickToChange")}`}
              >
          ...
          <TooltipContent side="bottom" sideOffset={4}>
            <p className="text-sm">{t("tooltip")}</p>
          </TooltipContent>
            ...
            {locales.map((loc) => (
              <DropdownMenuItem
                ...
                className={cn(
                  ...
                  loc.dir === "rtl" && "font-arabic text-right",
